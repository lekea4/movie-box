...
export function convertMovieToFormData(movie: movieCreationDTO) {
  ...
  formData.append("inTheaters", String(movie.inCinemas));
  ...
  formData.append("movieTheatersIds", JSON.stringify(movie.movieCinemasIds));
  formData.append("actors", JSON.stringify(movie.actors));

  return formData;
}

//to make sure the date is of the same format as the backend
